...
def worker_func(members,idx):
    s_results = ssf.original_s_expected_density_parallel(idx,sof_dic)
    
     my_results = sigf.cut_expected_density_members(members, N_std=N_sigma_ellipse_axis, X=var_dict["share_X"], art_X=var_dict["share_art_X"], N_art=N_art,
                                         min_members=min_members)
    return my_results, s_results
